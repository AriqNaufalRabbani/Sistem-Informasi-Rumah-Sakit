...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <p class="navbar-text navbar-right"><?php echo $_SESSION['username']; ?> login sebagai <?php echo $_SESSION['hak_akses']; ?> <?php echo $_SESSION['grup']; ?> | <a class="btn btn-default btn-xs" href="logout.php"><i class="glyphicon glyphicon-off"></i> Logout</a></p>
    </nav>
  </header>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="departemen.php?view=tampil-pasien">
            <i class="fa fa-book"></i> <span>Pasien </span>
          </a>  
        </li>
        <li class="treeview">
          <a href="departemen.php?view=tampil-jadwal-dokter">
            <i class="fa fa-folder"></i> <span> Dokter</span>
          </a>
        </li>
        ...
        <div id="page-wrapper" >
            <div id="page-inner"  style="background-color: white;">
                <?php 
                    if (isset($_GET['view'])) 
                    {
                        if ($_GET['view']=="aksi-ubah-pasien") 
                        {
                            include 'departemen/aksi_ubah_pasien.php';
                        }
                        elseif ($_GET['view']=="tampil-jadwal-dokter") 
                        {
                            include 'departemen/tampil_jadwal_dokter.php';
                        }
                        elseif ($_GET['view']=="tampil-pasien") 
                        {
                            include 'departemen/tampil_pasien.php';
                        }                     
                    }
                    else
                    {
                        include 'departemen/dashboard.php';
                    }
                ?>
            </div>
             <!-- /. PAGE INNER  -->
